...
export const SocialLinks = () => {
  return (
    <div className="social-content">
      <Link
        className="icon-only"
        to="https://www.tripadvisor.co.za/Attraction_Review-g312659-d10092528-Reviews-Jewel_of_Africa_Safaris-Cape_Town_Central_Western_Cape.html"
        target="_blank"
        rel="nofollow"
      >
        <svg
      ...
      <Link
        className="icon-only"
        to="https://www.facebook.com/jewelofafricasafaris"
        target="_blank"
        rel="nofollow"
      >
        <svg
      ...
      <Link
        className="icon-only"
        to="https://twitter.com/JewelofAfricaSA"
        target="_blank"
        rel="nofollow"
      >
        <svg
      ...
      <Link
        className="icon-only"
        to="https://www.instagram.com/joa_safaris/"
        target="_blank"
        rel="nofollow"
      >
        <svg
