...
const travelStyle_options = [
  {
    ...
    code: "luxury",
    description:
      "Private game drives, ultra-luxurious lodges, and world-class service.",
  },
  {
    name: "Family Friendly",
    code: "family",
    description:
      "Child-friendly lodges, fun activities, and educational wildlife encounters.",
  },
  {
  ...
  },
  {
    ...
    code: "photography",
    description:
      "Expert-guided, prime wildlife locations, and private vehicles.",
  },
  {
    name: "Active & Adventure",
    code: "active",
    description:
      "Walking safaris, gorilla trekking, and thrilling off-road explorations.",
  },
  {
    name: "Safari & Beach",
    code: "safari_beach",
    description:
      "Big 5 safaris paired with idyllic island and coastal escapes.",
  },
  {
    name: "Wildlife Safari",
    code: "wildlife",
    description:
      "Iconic Big 5, rare species, and unforgettable game-viewing experiences.",
  },
  {
    name: "Food & Wine",
    code: "food_wine",
  ...
  },
  {
    ...
    code: "wellness",
    description:
      "Spa treatments, yoga, and relaxation in peaceful wilderness settings.",
  },
];
    ...
    <div className="form-detail">
      ...
      <Form.Group className="mb-4">
        <Form.Label className="fw-bold">
          What type of safari experience do you want?
        </Form.Label>
        <p>
          Every safari package is custom-designed and unique. Choose the style
          of travel that best suits your vision:
        </p>
        <div>
            ...
            <div key={option.code} className="mb-2">
              <Form.Label className="d-flex align-items-center">
                ...
                <p className="fw-bold m-0">
                  {option.name}:{" "}
                  <i className="fw-light">{option.description}</i>
                </p>
              </Form.Label>
            </div>
          ))}
      ...
      <Form.Group className="mb-4">
        <Form.Label className="fw-bold">
          Tell us about your African dream:
        </Form.Label>
