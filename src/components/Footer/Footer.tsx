				...
				<Container>
					<Row className='py-5'>
						<Col xs={12} md={3} className='mb-4'>
							...
							/>
							<p className='my-4'>
								Jewel of Africa Safaris is an award winning, family owned, South African, luxury tour operator offering you
								effortless access to personalized, tailor-made safaris in Southern and East Africa.
							</p>
							<p className='m-0'>
							...
							<p className='m-0'>
								<Link to='mailto:travel@joasafaris.com'>travel@joasafaris.com</Link>
							</p>
							<p className='m-0'>
						...
						<Col xs={12} md={3} className='mb-4'>
							...
							<p className='m-0'>
								<Link to='/'>Best of Kruger Cape, Town and Victoria Falls Safari</Link>
							</p>
							<p className='m-0'>
