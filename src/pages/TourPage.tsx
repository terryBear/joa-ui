          ...
          <Row className="mt-5">
            ...
            <Col xs={12} md={4} lg={3} className="">
              ...
              <div className="card p-4 border-1">
                <h6 className="font-family-button text-uppercase mb-3">
                  Request A Quote
                </h6>
              ...
              <div className="page-detail-tabs">
                ...
                >
                  <Tab eventKey="overview" title="overview" key="overview">
                    ...
                    <Row>
                      {tour?.highlights?.map((highlight: Highlights) => (
                        <Col
                          ...
                          md={6}
                          className="mb-4"
                          key={`highlights-${highlight.title}`}
                        >
                          <div className="d-flex align-items-center">
                            <i className="bi bi-check-circle text-primary me-3"></i>
                            <p className="m-0">
                    ...
                    <Row>
                      {tour?.accomodation?.map(
                        (accomodation: AccomodationType) => (
                          <Col
                            xs={12}
                            md={6}
                            className="mb-4"
                            key={`highlights-${accomodation}`}
                          >
                            <div className="d-flex align-items-center">
                              <i className="bi bi-check-circle text-primary me-3"></i>
                              <p className="m-0">
                    ...
                    <Row>
                      <Col xs={12} md={6} className="mb-4">
                        ...
                        {tour?.inclusions?.map((item, index) => (
                          <div key={index}>
                            <h6 className="font-family-button mt-4">
                              {item.title}
                            </h6>
            ...
            <Col xs={12} className="">
              ...
              <Row>
                {TOURS.map((_tour, index) => (
                  <Col
                    xs={12}
                    md={4}
                    className="mb-4"
                    key={`similar-index-${_tour.slug}`}
                  >
                    <TourCard
                      handleClick={(_tour) => {
                        console.log(_tour);
            ...
            <Col xs={12} className="">
              <h3 className="mt-5 text-center mb-4">
                Similar to {tour.safari_types[0].title}
              </h3>
              <Row>
                {TOURS.map((__tour, index) => (
                  <Col
                    xs={12}
                    md={4}
                    className="mb-4"
                    key={`index-similar-${tour.slug}`}
                  >
                    <TourCard
                      handleClick={(__tour) => {
                        console.log(__tour);
