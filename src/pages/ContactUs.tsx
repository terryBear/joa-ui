				...
				<Container className='my-5'>
					<Row>
						...
						<Col xs={12} md={6} className='text-left'>
							...
							<p>
								Connect with us via email or phone. Jewel of Africa Safaris’ dedicated team can respond to your queries, or
								offer advice, in Dutch, English, German or Afrikaans. Contact us now.
							</p>
